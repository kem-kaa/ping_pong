...
player_rect = pygame.Rect(30, HEIGHT//2-BALL_SIZE//2,PADDLE_WIDTH, PADDLE_HEIGHT)

ai_rect = pygame.Rect(WIDTH-30, HEIGHT//2-BALL_SIZE//2,PADDLE_WIDTH, PADDLE_HEIGHT)
